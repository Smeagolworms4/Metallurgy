...
//    }
    ...
    public void addSwordEffects()
    {
        ...
        if (fantasySet.getOreInfo("Aredrite").sword != null)
        {
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        ironDustID = vanillaConfig.getItem("Item IDs", "Iron Dust", ironDustID).getInt();
        goldDustID = vanillaConfig.getItem("Item IDs", "Gold Dust", goldDustID).getInt();
